...
iterable_named_enum! {
    ...
    pub enum Ticker {
        ...
        WalPrecreateHit("rocksdb.wal.precreate.hit"),
        WalPrecreateMiss("rocksdb.wal.precreate.miss"),
        WalPrecreateWaited("rocksdb.wal.precreate.waited"),
        WalPrecreateWaitMicros("rocksdb.wal.precreate.wait.micros"),
        WalPrecreateFailed("rocksdb.wal.precreate.failed"),
        ...
        RateLimiterBytesRead("rocksdb.rate.limiter.bytes.read"),
        RateLimiterBytesWrite("rocksdb.rate.limiter.bytes.write"),
        RateLimiterRequestsRead("rocksdb.rate.limiter.requests.read"),
        RateLimiterRequestsWrite("rocksdb.rate.limiter.requests.write"),
        RateLimiterDelayedRequestsRead("rocksdb.rate.limiter.delayed.requests.read"),
        RateLimiterDelayedRequestsWrite("rocksdb.rate.limiter.delayed.requests.write"),
        RateLimiterTotalWaitMicrosRead("rocksdb.rate.limiter.total.wait.micros.read"),
        RateLimiterTotalWaitMicrosWrite("rocksdb.rate.limiter.total.wait.micros.write"),
        ...
        ReadPathRangeTombstonesInserted("rocksdb.read.path.range.tombstones.inserted"),
        ReadPathRangeTombstonesDiscarded("rocksdb.read.path.range.tombstones.discarded"),
        FileOpenMetadataRetrieved("rocksdb.file.open.metadata.retrieved"),
        FileOpenMetadataPassed("rocksdb.file.open.metadata.passed"),
        ManifestValidationFailureCount("rocksdb.manifest.validation.failure.count"),
        FlushReasonWriteBufferFull("rocksdb.flush.reason.write_buffer_full"),
        FlushReasonWriteBufferManager("rocksdb.flush.reason.write_buffer_manager"),
        FlushReasonMemtableMaxRangeDeletions("rocksdb.flush.reason.memtable_max_range_deletions"),
        AtomicFlushRequestReasonWriteBufferFull("rocksdb.atomic_flush.request.reason.write_buffer_full"),
        AtomicFlushRequestReasonWriteBufferManager("rocksdb.atomic_flush.request.reason.write_buffer_manager"),
        AtomicFlushRequestReasonMemtableMaxRangeDeletions("rocksdb.atomic_flush.request.reason.memtable_max_range_deletions"),
        AtomicFlushRequestReasonOther("rocksdb.atomic_flush.request.reason.other"),
        CheckpointReadBytes("rocksdb.checkpoint.read.bytes"),
        CheckpointWriteBytes("rocksdb.checkpoint.write.bytes"),
        FileSubmitAsyncReadFallback("rocksdb.file.submit.async.read.fallback"),
    }
}
